...
cell_size = 35
cell_number = 20
screen = pygame.display.set_mode((screen_cell_number * cell_size, screen_cell_number * cell_size), pygame.RESIZABLE)
clock = pygame.time.Clock()

# Assets
bread = pygame.image.load("assets/bread.png")
mom_duck = pygame.image.load("assets/duck_player.png")
baby_duck = pygame.image.load("assets/rubber-duck.png") 
